  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      ...
      <form action="{{ route('password.reset', ['token' => $token]) }}" method="POST">
          ...
          @if ($errors->has('email'))
            <div class="error invalid-feedback" style="display: block;">{{ $errors->first('email') }}</div>
          @endif

          @if ($errors->has('token'))
            <div class="error invalid-feedback" style="display: block;">{{ $errors->first('token') }}</div>
          @endif
