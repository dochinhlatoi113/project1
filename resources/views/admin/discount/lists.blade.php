            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <form id="formCate" 
                        action="{{ route('admin.discount_deleteall') }}" 
                        method="POST">
                        @csrf
                        <table class="table table-bordered table-hover dataTable" id="category">
                            ...
                            <tr>
                              ...
                              <th class="sorting"> 
                                   <div class="row">  
                                      ...
                                      <div class="col-2"> 
                                        <span><a class="search" data-url="url"href="{{ route('admin.index', ['sort_by' => 'ASC', 'keywork' => $keywork]) }}" style="color: black;">↑</a></span>
                                        <span><a data-url="url" href="{{ route('admin.index', ['sort_by' => 'DESC', 'keywork' => $keywork]) }}" class="search"style="color: black;">↓</span>
                                    </div>  
                                  </div>
                              </th>
                          ...
                          <tbody id = "searchList">
                              ...
                              <tr>
                                ...
                                <td>
                                  <a href="{{route('admin.discount_edit', ['id' =>$list['id']] )}}" class="btn btn-warning">Sửa</a>

                                  <a href="javascript:void(0)" data-url="{{ route('admin.discount_delete', ['id' =>$list['id']] ) }}" class="btn btn-danger butDelete">Xóa</a>
                                </td>
                                <td>
                                  <div class="checkbox">
                    ...
                    <div class="card-footer clearfix">
                      ...
                      <button type="button" class="btn btn-success">
                          <a class="bnt-link__new" href="{{route('admin.index_insert')}}"> Tạo mới </a>
                      </button>
                    </div>
                </div>
                <!-- /.card -->
